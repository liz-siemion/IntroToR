...
*The top-left panel in RStudio is the script editor, where you write and save your code. When you run a line of code from the script, the output appears in the Console (bottom-left panel). While you can type and run code directly in the Console, it won’t be saved when you close R unless you explicitly save your R history. That’s why it’s best to write your code in the script editor—so you have a permanent, editable copy—and send lines to the Console to execute as needed.
