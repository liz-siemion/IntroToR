...
3. Subset to just females using the `subset()`, which indexing, and the `filter()` function.
...
4. Subset to herds in the Souther Recovery Unit: Mt. Baxter, Mt. Langley, Taboose Creek, Sawmill Canyon, Bubbs Creek, Mt. Williamson. You will need to use `%in%`. Any subsetting method is ok to use
